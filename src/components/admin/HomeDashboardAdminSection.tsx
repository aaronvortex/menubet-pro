...
import {
  ...
  ToggleLeft, ToggleRight, Tag, Megaphone as PromoIcon,
} from 'lucide-react'
import {
  HomeSpecial, HomePromotion, getScheduleStatus,
...
export const HomeDashboardAdminSection: React.FC<HomeDashboardAdminSectionProps> = ({ activeTab }) => {
  const [subTab, setSubTab] = useState<'specials' | 'promotions'>('specials')
      ...
      <AnimatePresence>
        ...
        {deletingSpecialId && (
          <MiniConfirmModal
            ...
            onConfirm={async () => {
              await deleteSpecial(deletingSpecialId)
        ...
        {deletingPromoId && (
          <MiniConfirmModal
            ...
            onConfirm={async () => {
              await deletePromotion(deletingPromoId)
